...
import bitflyday.com.mobile.application.a2activityrdiff.databinding.FragmentSecond2Binding
...
private var _binding: FragmentSecond2Binding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.buttonSecond.setOnClickListener {
            findNavController().navigate(R.id.action_Second2Fragment_to_mainActivity)
        }
    }
